...
<body>
	...
	<nav class="nav">
		<ul class="nav_list">
			...
			<%}else{%>
			<!-- 已經登入 -->
			<li class="nav_list_item"><a href=# class="nav_list_a">會員修改</a></li>
			<li class="nav_list_item"><a href=# class="nav_list_a">歷史訂單</a></li>
			<%}%>
			<li class="nav_list_item nav_list_last_item"><a href="products_list.jsp" class="nav_list_a">全部電影</a></li>
		</ul>
		<div class = "nav_user"><%=member!=null?(member.getName()+" 你好"):"尚未登入" %></div>
	</nav>
	<article>
